...
import practice.entity.item.Album;
...
public class Main {
    ...
    private static void logic(EntityManager em) {
        ...
        karina.setName("카리나");
        karina.setAddress(new Address("서울", "강남", "123-123"));
        em.persist(karina);
        ...
        delivery1.setAddress(karina.getAddress());
        ...
        em.persist(order1); // 주문 저장 시, 연관된 주문 상품, 배송도 함께 저장된다.
